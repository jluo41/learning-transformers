...
def main():
    ...
    # --------------------- Part 1.1: Model Args: model_type  --------------------- #
    parser.add_argument(
        "--model_type",
        default=None,
        type=str,
    ...
    # --------------------- Part 1.2: Model Args: model_name_or_path  --------------------- #
    parser.add_argument(
        "--model_name_or_path",
        default=None,
        type=str,
    ...
    # --------------------- Part 5: preprocessing for encoded_prompt --------------------- #
